...
// Função para formatar data sem as coordenadas de timezone - FORÇANDO BRASÍLIA
const formatDate = (isoDate: string | null | undefined): string => {
  if (!isoDate) return '';
  
  try {
    // Cria a data e ajusta explicitamente para o timezone de Brasília
    ...
    // Formata manualmente no formato DD/MM/YYYY HH:mm
  ...
  const validateAndUpdateAgendamento = () => {
    ...
    // Verifica se já existe agendamento no mesmo dia e horário (ignorando o atual)
    const agendamentoExistente = verificarAgendamentoExistente(
  ...
  const showModal = (type: 'addAgendamento' | 'editAgendamento' | 'deleteAgendamento') => {
    if (type === 'editAgendamento' && currentAgendamento) {
      ...
      setSelectedUsuario(currentAgendamento.fk_usuario_id.toString());
        ...
        <View style={styles.detailsContainer}>
          <View style={styles.detailRow}>
            <View style={styles.detailItem}>
              <Text style={styles.detailLabel}>Data do Agendamento</Text>
      ...
      <PaperProvider>
        <SafeAreaView style={styles.container}>
          ...
          <View style={styles.sectionHeader}>
            <Text style={styles.sectionTitle}>Lista de Agendamentos</Text>
              ...
              <View style={styles.modalContent}>
                {currentAgendamento && (
                  <View style={styles.currentDataContainer}>
                    ...
                    <Text style={styles.currentDataItem}>Cliente: {currentAgendamento.usuarioNome}</Text>
