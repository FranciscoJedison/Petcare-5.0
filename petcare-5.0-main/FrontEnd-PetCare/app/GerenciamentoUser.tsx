...
const GerenciamentoUser = () => {
  ...
  return (
    <PaperProvider>
      <LinearGradient colors={['#00BFA6', '#f9f9f9' ,'#FFFFFF']} style={{ flex: 1 }}>
                    ...
                    <View style={styles.cardContent}>
                      ...
                      <View style={styles.cardActions}>
                        <IconButton
                          ...
                          iconColor="#fff"
                          style={[styles.actionButton, { backgroundColor: '#00BFA6' }]}
                        />
                        <IconButton
                          icon="delete"
                          size={22}
...
const styles = StyleSheet.create({
  ...
  cardText: { color: '#555', fontSize: 14, marginBottom: 2 },
  cardActions: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 },
  actionButton: { marginHorizontal: 3, borderRadius: 30, width: 42, height: 42, justifyContent: 'center', alignItems: 'center' },
  ...
  agendamentoButton: { backgroundColor: '#00BFA6', marginTop: 10 },
  deleteButton: { backgroundColor: '#E53935', marginTop: 10 },
  counterText: { marginTop: 10, fontSize: 16, fontWeight: 'bold', textAlign: 'center', color: '#333' },
});
